@if (isset($header))
  <nav class="z-20 py-4 md:mx-8 sticky top-0 bg-white shadow dark:bg-slate-800 md:bg-transparent rounded-xl">
      <div class="container flex items-center justify-between h-full px-4 mx-auto text-indigo-600 dark:text-indigo-300">
         <a class="md:text-slate-700 dark:text-gray-200 text-sm uppercase hidden lg:inline-block font-semibold" href="/">
            {{ $header }}
         </a>
         <div>
